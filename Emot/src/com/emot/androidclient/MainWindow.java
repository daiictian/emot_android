...
import com.emot.androidclient.dialogs.AddRosterItemDialog;
import com.emot.androidclient.dialogs.ChangeStatusDialog;
import com.emot.androidclient.dialogs.FirstStartDialog;
import com.emot.androidclient.dialogs.GroupNameView;
import com.emot.androidclient.preferences.AccountPrefs;
import com.emot.androidclient.preferences.MainPrefs;
...
import com.emot.androidclient.util.SimpleCursorTreeAdapter;
...
public class MainWindow extends SherlockExpandableListActivity {
	...
	protected void onPause() {
		...
		EmotApplication.getApp(this).mMTM.unbindDisplayActivity(this);
		unbindXMPPService();
		storeExpandedState();
	}
	...
	protected void onResume() {
		...
		EmotApplication.getApp(this).mMTM.bindDisplayActivity(this);
