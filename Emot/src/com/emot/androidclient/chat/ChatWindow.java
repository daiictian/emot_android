...
public class ChatWindow extends ActionBarActivity implements OnKeyListener,
	...
	private EmotEditText mChatInput = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mChatFontSize = Integer.valueOf(EmotApplication.getConfig(this).chatFontSize);
	...
	private void setUserInput() {
		Intent i = getIntent();
		mChatInput = (EmotEditText) findViewById(R.id.Chat_UserInput);
		mChatInput.addTextChangedListener(this);
		if (i.hasExtra(INTENT_EXTRA_MESSAGE)) {
			mChatInput.setText(i.getExtras().getString(INTENT_EXTRA_MESSAGE));
		}

		mChatInput.setEmotSuggestionLayout((LinearLayout)findViewById(R.id.viewEmotSuggestionLayout));
	}
	...
	public class ChatItemWrapper {
		...
		private EmotTextView mMessageView = null;
...
//			Log.i(TAG, "populateFrom(" + from_me + ", " + from + ", " + message + ")");
		...
		TextView getMessageView() {
			if (mMessageView == null) {
				mMessageView = (EmotTextView) mRowView
